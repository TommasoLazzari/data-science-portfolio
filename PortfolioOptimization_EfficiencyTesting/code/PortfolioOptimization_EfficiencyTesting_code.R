...
barplot(t(w.gmv.vinc.S1), las=2, main="Weights of Long-Only Global Minimum Variance Portfolio - S1")
barplot(t(w.gmv.vinc.S2), las=2, main="Weights of Long-Only Global Minimum Variance Portfolio - S2")
barplot(t(w.gmv.vinc.S3), las=2, main="Weights of Long-Only Global Minimum Variance Portfolio - S3")
...
barplot(t(w.to.vinc.S1), las=2, main="Weights of Long-Only Maximum Trade-Off Portfolio - S1")
barplot(t(w.to.vinc.S2), las=2, main="Weights of Long-Only Maximum Trade-Off Portfolio - S2")
barplot(t(w.to.vinc.S3), las=2, main="Weights of Long-Only Maximum Trade-Off Portfolio - S3")
